  ...
  return (
    <Tailwind>
      <Html className="font-sans bg-gray-100">
        <Head />
        <Preview>Thank you for your order from JC BLADES</Preview>
        <Body className="bg-white my-10 mx-auto w-full max-w-2xl">
          {/* Header */}
          <Section className="bg-[#27272a] text-white px-6 py-4">
            <Img src="https://filwawqhhhfsaxvstiuq.supabase.co/storage/v1/object/public/image//jcbladeslogo1.png" alt="JC Blades Logo" width="128" height="auto" className="mx-auto" />
          </Section>
          ...
          <Section className="bg-gray-50 p-6 mt-10">
            <Text className="text-center text-gray-500 text-sm">
              If you have any questions, reply to this email or contact our support team at support@jcblades.com.
            </Text>
            <Text className="text-center text-gray-500 text-sm">
              Order Token: {order.id}
            </Text>
            <Text className="text-center text-gray-400 text-xs mt-4">
              © {new Date().getFullYear()} JC Blades, Inc. All rights reserved.
            </Text>
          </Section>
        </Body>
      </Html>
